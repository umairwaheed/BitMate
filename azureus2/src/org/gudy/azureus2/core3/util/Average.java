...
public class Average {
  ...
  */
  ...
  public static void main(String argv[]) {
	  System.out.println(SystemTime.getSteppedMonotonousTime());
	  Average test = Average.getInstance(1000, 10);
	  final int MAINLOOP_ONE_SECOND_INTERVAL = 600000 * (1000 / PeerControlScheduler.SCHEDULE_PERIOD_MILLIS);
	  System.out.println(MAINLOOP_ONE_SECOND_INTERVAL);
	  long mainloop_loop_count = -1;
	  for(int i=0; i>-1; i++) {
		  mainloop_loop_count += 1;
		  if ( (mainloop_loop_count %MAINLOOP_ONE_SECOND_INTERVAL) != 0 ){
			  //System.out.println("in loop");
				continue;
			}
		  test.addValue(2);
		  System.out.println("Average is " + test.getDoubleAverage());
