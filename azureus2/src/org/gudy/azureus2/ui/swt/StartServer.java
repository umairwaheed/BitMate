...
StartServer
{
  ...
  {
    bContinue = true;
    System.out.println("I am polling for the connections.");
    while (bContinue) {
      BufferedReader br = null;
      try {
    	  System.out.println("Waiting for the new connections");
        Socket sck = socket.accept();
        System.out.println("Got new remote connection from " + sck.getInetAddress().getHostAddress());
