...
public class AboutWindow {
  ...
  private static void _show() {
    ...
    Group gBitMate = new Group(window, SWT.NULL);
    GridLayout gridLayout2 = new GridLayout();
    gridLayout2.numColumns = 1;
    gridLayout2.makeColumnsEqualWidth = true;
    gBitMate.setLayout(gridLayout2);
    Messages.setLanguageText(gBitMate, "MainWindow.about.section.bitmate"); //$NON-NLS-1$
    gridData = new GridData(GridData.VERTICAL_ALIGN_FILL | GridData.HORIZONTAL_ALIGN_FILL);
    gridData.horizontalSpan = 2;
    gBitMate.setLayoutData(gridData);
    ...
    Text txtSysInfo2 = new Text(gBitMate, SWT.READ_ONLY | SWT.MULTI | SWT.WRAP);
    txtSysInfo2.setBackground(display.getSystemColor(SWT.COLOR_WIDGET_BACKGROUND));
    txtSysInfo2.setText("This is modified version of Vuze client called BitMate.\n" +
    		"BitMate is based on vuze code (version 4.5.1.1_CVS).\nBitMate is a research project " +
    		"of Lahore University of Management and Sciences, Pakistan.\nFor further information " +
    		"visit http://www.dritte.org/bitmate.html.\nBitMate is distributed under the" +
    		"same license as that of Vuze.");
    
    gridData = new GridData(GridData.FILL_HORIZONTAL);
    gridData.horizontalSpan = 1;
    txtSysInfo2.setLayoutData(gridData);
    if (window.getCaret() != null)
    	window.getCaret().setVisible(false);
